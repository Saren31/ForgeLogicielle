...
public class ActionComposeeYan extends Action {

    private final Map<ActionSimple, Float> composition;

    public ActionComposeeYan(String libelle, Map<ActionSimple, Float> composition) {
        super(libelle); 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionComposeeYan)) return false;
        if (!super.equals(o)) return false;
        ActionComposeeYan that = (ActionComposeeYan) o;
